  ...
  return (
    <>
      <section className="hero-section hero-1 fix">
        <div className="shape-left"><img src="assets/img/hero/shape-left.png" alt="" /></div>
        <div className="shape-right"><img src="assets/img/hero/shape-right.png" alt="" /></div>
        <div className="dot-shape float-bob-x"><img src="assets/img/hero/dot.png" alt="" /></div>
        <div className="vector-shape float-bob-y"><img src="assets/img/hero/vectoe.png" alt="" /></div>
        
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="hero-content">
                <span className="wow fadeInUp">Welcome {user ? user.userName.replace("|"," ") : ""} to Eduspace</span>
                <h1 className="wow fadeInUp" data-wow-delay=".3s">
                  Interactive Learning Engaging Students in the Digital Age
                </h1>
                <h3 className="wow fadeInUp" data-wow-delay=".5s">
                  Get {courseCount > 0 ? `${courseCount.toLocaleString()}+` : 'Thousands of'} Best Quality Online Courses
                </h3>
                <div className="hero-button wow fadeInUp" data-wow-delay=".7s">
                  <Link to="/courses" className="theme-btn hover-white">Find Your Best Courses</Link>
                </div>
              </div>
            </div>
                ...
                <div className="content">
                  <h2>
                    <span className="odometer" data-count={reviewCount}>
                      {reviewCount > 0 && <Count number={reviewCount} text="+" />}
                    </span>
                  </h2>
                  <p>Total Positive Reviews</p> {/* Restored to simple text */}
                </div>
                <img src="assets/img/hero/trustpilot-logopng.png" alt="Trustpilot Logo" />
              </div>
