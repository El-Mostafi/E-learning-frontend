  ...
  return (
    <>
      <section className="cta-newsletter-section fix blue-bg">
        ...
        <div className="shape-1"><img src="assets/img/cta/shape-1.png" alt="" /></div>
        <div className="shape-2"><img src="assets/img/cta/shape-2.png" alt="" /></div>
        ...
        <div className="container">
          <div className="cta-newsletter-wrapper">
            ...
            <div className="cta-button-wrapper text-center wow fadeInUp" data-wow-delay=".5s">
            ...
            <ul className="list-items wow fadeInUp" data-wow-delay=".7s">
              ...
              <li>
                ...
                {studentCount > 0 ? `${studentCount.toLocaleString()}+` : "Thousands of"} Happy Students
              </li>
            </ul>
          </div>
        </div>
