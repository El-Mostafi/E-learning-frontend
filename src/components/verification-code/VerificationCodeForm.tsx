...
const VerificationCodeForm = () => {
    ...
    const verifyCode = async (codeArray: string[]) => {
      ...
      try {
        const response = await authService.verifyEmail(email,codeArray.join(''));
    ...
    const handleResendCode = async () => {
      ...
      await authService.resendEmail(currentUser.data.currentUser.email, currentUser.data.currentUser.userName);
      setTimeLeft(1800);
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center p-4">
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <button
                ...
                className={`text-blue-600 hover:text-blue-700 font-medium transition-colors ${
                  (isResending || timeLeft > 1740) ? 'opacity-50 cursor-not-allowed' : ''
                }`}
              >
            ...
            {isVerified ? (
              <button
                className="w-full bg-green-500 text-white font-semibold py-3 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2"
              >
              ...
              <button
                ...
                className={`w-full font-semibold py-3 rounded-lg transition-all duration-300
                  ${isVerifying ? 'bg-blue-400 cursor-wait' : 'bg-blue-600 hover:bg-blue-700'}
